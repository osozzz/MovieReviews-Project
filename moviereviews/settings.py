...
BASE_DIRX = Path(__file__).resolve().parent
...
SECRET_KEY = 'django-insecure-y=kl^zr1cs!q+rt2-ai1=))d4zv6%yo-)xo@!k(q%f1syso^_f'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['mysite.com', "127.0.0.1", 'localhost', '35.188.149.79']
